...
Note: Representation Learning Models (RLMs) can be either pretrained or not, but training (or reuse) takes place during the stage of Preprocessing. RLMs cna be in the NLP, Computer Vision or other domain.
